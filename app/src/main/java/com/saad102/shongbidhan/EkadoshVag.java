...
public class EkadoshVag extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ekadosh_vag);
        AdView mAdView1;
        AdView mAdView2;
        AdView mAdView3;
        AdView mAdView4;
        ...
        MobileAds.initialize(EkadoshVag.this, "ca-app-pub-9080134869791919~2786856699");
